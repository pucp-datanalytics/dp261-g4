...
def load_dashboard_bundle() -> dict:
    return {
        ...
        "economic_comparison": load_csv("models/c_model_economic_comparison.csv"),
        "profit_curve": load_csv("models/c_profit_curve_by_model.csv"),
        "baseline_comparison": load_csv("models/c_baseline_comparison_usd.csv"),
